            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
               ...
               <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="quantity" value="<?php echo e($product->quantity); ?>" class="form-control" placeholder="Quantity">
                </div>
            </div>
...
<?php echo $__env->make('products.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practicelaravel\resources\views/products/edit.blade.php ENDPATH**/ ?>